...
# * Loading an image dataset from a local directory and inspecting its metadata
# * Semantic search with multimodal embeddings (text + image) from the [CLIP](https://arxiv.org/pdf/2103.00020) model 
